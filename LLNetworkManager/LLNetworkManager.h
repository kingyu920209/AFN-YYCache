...
/// 请求成功的Block
typedef void(^LLHttpRequestSuccess)(id responseObject);

/// 请求失败的Block
typedef void(^LLHttpRequestFailed)(NSError *error);

/// 缓存的Block
typedef void(^LLHttpRequestCache)(id responseCache);

/// 上传或者下载的进度, Progress.completedUnitCount:当前大小 - Progress.totalUnitCount:总大小
typedef void (^LLHttpProgress)(NSProgress *progress);
 ...
 *
 *  @param requestSerializer LLRequestSerializerJSON(JSON格式),PPRequestSerializerHTTP(二进制格式),
 */
 ...
 *
 *  @param responseSerializer LLResponseSerializerJSON(JSON格式),PPResponseSerializerHTTP(二进制格式)
 */
